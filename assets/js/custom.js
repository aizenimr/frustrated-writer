    ...
    let appendToot = function (status_) {
      ...
      if (status_.reblog) {
        ...
        user =
          ...
          status_.account.url +
          '" rel="noopener noreferrer" target="_blank">'
          + svgIcon + '@' + status_.account.username + '<span class="visually-hidden"> post</span></a></div>';
